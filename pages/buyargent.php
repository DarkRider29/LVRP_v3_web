...
$playername = $row['Name'];
$tokens = $row['Tokens'];
$renamexe = $row['PointsRename'] + 2;
$changnumxe = $row['ChangeNum'] + 1;
$changplaquexe = $row['ChangePlaque'] + 1;
$respectexe = $row['Respect'] + 4;
$viptime = $row['VipTime']+5760;
$tokensvalue = 299;
$tokensvalues = 300;
...
mysql_query($req);
if($row['DonateRank'] < 2)
	{mysql_query("UPDATE lvrp_users SET DonateRank=2 WHERE Name = '$playername'");}
...
log_Buy($playername,"Pack VIP ARGENT");
echo"
